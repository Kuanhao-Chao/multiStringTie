...
//                 CGraphnode* node = no2gnode->Get(i);
//                 no2gnodeGp[s][cgidx].Add(node);
//                 fprintf(stderr, "Inside!! cgidx: %d \n", cgidx);
//                 fprintf(stderr, "no2gnode->Get(i)->nodeid: %d \n", node->nodeid);
//                 fprintf(stderr, "no2gnodeGp[s][0]->Last()->nodeid: %d \n", no2gnodeGp[s][0].Last()->nodeid);
//                 if (cgidx >= 1) {
//                     fprintf(stderr, "no2gnodeGp[s][cgidx-1]->Last()->nodeid: %d \n", no2gnodeGp[s][cgidx-1].Last()->nodeid);
//                     fprintf(stderr, "no2gnodeGp[s][cgidx]->Last()->nodeid: %d \n", no2gnodeGp[s][cgidx].Last()->nodeid);
//                     // fprintf(stderr, "no2gnodeGp[s][cgidx+1]->Last()->nodeid: %d \n", no2gnodeGp[s][cgidx+1].Last()->nodeid);
//                 }
//             }
...
//                 // int unispg_start = no2gnodeGp[s][10000][1]->start;
//                 // int unispg_end = no2gnodeGp[s][10000][ no2gnodeGp[s][10000].Count()-2 ]->end;

//                 fprintf(stderr, "$$$      cgidx: %d\n", cgidx);
//                 fprintf(stderr, "$$$      no2gnodeGp[s]: %d\n", sizeof(no2gnodeGp[s]));
//                 fprintf(stderr, "$$$  track_idx: %d\n", track_idx);
//                 fprintf(stderr, "$$$ lclg_start: %d,  lclg_end: %d,  unispg_start: %d,  unispg_end: %d\n", lclg_start, lclg_end, no2gnodeGp[s][cgidx][1]->start, no2gnodeGp[s][cgidx][ no2gnodeGp[s][cgidx].Count()-2 ]->end);
...
//                 // for (int i = 0; i < no2gnodeGp[s][10000].Count(); i++) {
//                 //     fprintf(stderr, "&&&& This is the global graphnode: %d\n", no2gnodeGp[s][10000][i]->nodeid);
//                 // }
//                 // // This is the local graph.
//                 // *no2gnode;
//                 // // This is the global graph.
//                 // no2gnodeGp[s][track_idx];
//             }
