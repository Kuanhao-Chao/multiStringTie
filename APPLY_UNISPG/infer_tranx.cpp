...
void infer_transcripts_unispg(BundleData* bundle, UnispgGp* unispg) {
    ...
    //     node_coverage = get_cov(s, unispg_nstart-refstart, unispg_nend-refstart, bundle->bpcov);

    //     // node_coverage = get_cov_sign(s, unispg_nstart-refstart, unispg_nend-refstart, bundle->bpcov);
